.PHONY: all format lint test test_unit test_integration test_e2e test_all evals eval_graph eval_multiturn eval_job_agent eval_graph_qwen eval_graph_glm eval_multiturn_polite eval_multiturn_hacker test_watch test_watch_unit test_watch_integration test_watch_e2e test_profile extended_tests dev dev_ui
...
help:
	...
	@echo 'eval_job_agent               - run deterministic Job Application Agent evaluation'
